...
Copy the code in `/home/jeckroth/csci221-public/homework-4` and finish writing the file `mathtree.cpp`. That's it!!1

## Grader script

`/usr/local/csci221sp2016/csci221-hw04-grader.pl`

Note, the ASCII trees need not be printed. You can comment out that code in main.cpp (but leave the cout's).

The test script handles some variability with parentheses and spaces. However, you might want to compare your output to the "gold standard" program `/home/jeckroth/csci221-public/homework-4/mathtree-comparison`
