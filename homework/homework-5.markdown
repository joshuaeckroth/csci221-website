...
`sin(-1.0)*2.0` and `-9.4^log(exp(cos(4.5)-2.3+3.5))`, which are
represented as tree datastructures. You will download some existing
code and fill in the blanks.
...
The expressions will be represented in "parse trees" such as the
following:
